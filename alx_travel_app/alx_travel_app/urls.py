...
urlpatterns = [
    path('auth/register', UserRegistrationView.as_view({'post': 'create'}), name='register_new_account'),
    path('auth/token/login', CustomTokenObtainPairView.as_view(), name='auth_token_pair'),
